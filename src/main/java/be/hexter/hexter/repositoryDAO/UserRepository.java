...
public interface UserRepository extends CrudRepository<User, Long> {
    ...
    @Query("Select user From User AS user WHERE user.firstname LIKE %?1% AND user.lastname LIKE %?2%")
    List<User> matchUsergroupByFirstAndOrLastname(String firstname, String lastname);
}
